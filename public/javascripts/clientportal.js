                    ...
                    .success(function successCallback(response) {
                        for (var key in response) {
                            ...
                            if (response[key].testtype === "urine") {
                                ...
                                h21 = angular.element('<h2>Glucose: ' + response[key].glucoseurine + ' mg/dL </h2>');
                                h22 = angular.element('<h2>Ketones: ' + response[key].ketones + ' mg/dL </h2>');
                                ...
                                h20 = angular.element('<h2>Cholesterol: ' + response[key].cholesterol + ' mg/dL</h2>');
                                h21 = angular.element('<h2>Blood Type: ' + response[key].bloodtype + '</h2>');
                                h22 = angular.element('<h2>Glucose: ' + response[key].glucoseblood + ' mg/dL</h2>');
                                h23 = angular.element('<h2>CPR: ' + response[key].cpr + ' mg/L</h2>');
                                h24 = angular.element('<h2>Test Date: ' + $filter('date')(response[key].date, "mediumDate") + '</h2>');
                            } else {
                                h20 = angular.element('<h2>Diastolic: ' + response[key].blooddiastolic + '</h2>');
                                h21 = angular.element('<h2>Systolic: ' + response[key].bloodsystolic + '</h2>');
                                h22 = angular.element('<h2>Respiratory Rate: ' + response[key].respiratoryrate + 'BPM</h2>');
                                h23 = angular.element('<h2>Heart Rate: ' + response[key].heartrate + ' BPM</h2>');
                                h24 = angular.element('<h2>Blood Temp: ' + response[key].bodytemperature + ' &degF</h2>');
